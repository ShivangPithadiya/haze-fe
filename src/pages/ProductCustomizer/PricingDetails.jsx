...
export default function PricingDetails() {
    ...
    const handleLayer = (event) => {
        ...
        setShowLayer(true); // Show the layer when any item is selected
    };
                                            ...
                                            <div className="active_products_section">
                                                <div className="my_products">
                                                    ...
                                                    {pricingData.length > 0 ? (
                                                        <div className="handle_color d-flex justify-content-between">
                                                            <div><b>Handle Color:</b> Neon Green: $10 | Neon Yellow: $10 | Neon Pink: $10</div>
                                                            <div><span>
                                        ...
                                        <div className="container">
                                            <div className="row">
                                                ...
                                                <div className="col-12 p-4 bg-white rounded shadow-sm">
                                                    ...
                                                    <div className="select_pricing d-flex align-items-center justify-content-between">
                                                        <span className="sidebar_menu_icon m-2">
                                                            <img src="assets/Image/them/Layers.svg" />
                                                        </span>
                                                        <div className='m-2'>
                                                            <select
                                                                className="add_theme_inner_container_select w-100 p-2"
                                                                onChange={handleLayer}
                                                                value={selectedLayer}
                                                            >
                                                                <option value=""><img src="assets/Image/modal/colour.svg" />Select Layer</option>
                                                                <option value="Handle Color">Handle Color</option>
                                                                <option value="Font Color">Font Color</option>
                                                                <option value="Mug Color">Mug Color</option>
                                                            </select>
                                                        </div>
                                                        <div className='m-2'>
                                                    ...
                                                    {showLayer && (
                                                        <div className="font_select mb-4 mt-2">
                                                            <div className="">
                                                                <div className='d-flex justify-content-between align-items-center'>
                                                                    <label htmlFor="">Neon Green</label>
                                                                    <input className="file_select_title p-2" placeholder='0' style={{ border: "1px solid #9C9C9C;" }} />
                                                                </div>
                                                                <br />
                                                                <div className='d-flex justify-content-between align-items-center'>
                                                    ...
                                                    <div className="d-flex justify-content-between mt-4">
                                                        ...
                                                        <button className="btn border-dark py-2 btn-block" onClick={handleCloseModal}>Cancel</button>
                                                        <a href="#" className="btn btn-dark py-2 btn-block mx-2">Add</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
