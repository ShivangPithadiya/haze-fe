        ...
        <div className='row general_row1'>
            ...
            <div className="col-12 p-2">
                ...
                <div class="file_select_section border-0">
                    <span class="file_select_title">Primary button background  colour</span>
                ...
                {/* secondary color */}
                <div class="file_select_section border-0">
                    <span class="file_select_title">Primary button
                        text colour</span>
                    <span className='color-select-span'>
                        <span className='p-3'>
                            {secondarycolorShow}
                ...
                {/* primary font size */}
                <div class="file_select_section border-0">
                    <span class="file_select_title">Primary button font size</span>
                ...
                {/* secondary font size */}
                <div class="file_select_section border-0">
                    <span class="file_select_title">Primary button rounding</span>
                    <span className='border p-2'>
