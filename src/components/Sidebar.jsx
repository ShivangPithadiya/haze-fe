...
import subscription from '../assets/Image/subscriptions.svg'
const Sidebar = ({ isSidebarOpen, closeNav }) => {
  ...
  const menu = {
    ...
    "super-admin": [
      { name: "Subscriptions", url: "/super-admin-subscriptions", icon: subscription },
    ],
    "super-admin-manager": [
      { name: "Subscriptions", url: "/super-admin-subscriptions", icon: subscription },
    ],
                ...
                <div className="custom-user-dropdown-options" id="userDropdownOptions">
                  ...
                  {userType === 'super-admin' ? <>
                    <Link to='/user-management'>
                      ...
                      User Management
                    </Link></> : userType === 'store-owner' ? <> <Link to='/user-manage'>
                      <span>
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          width="20"
